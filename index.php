...
<div class="container-fluid">
    ...
    <div class="row top">
        <div class="col-sm-5 hero-banner">
            ...
            <p class="white">
                ...
                MyCar Parking makes it easier than ever before.
            </p>
    ...
    <div class="row pin-park">
        ...
        <div class="col-sm-6 park-pin-pad">
            ...
            <p>
                ...
                Gone are the days of wondering where you parked! With MyCar Parking you will always know!
            </p>
    ...
    <div class="row grey-background">
        <div class="col-sm-6 park-pin-pad">
            ...
            <p class="white">
                ...
                parking garages. MyCar Parking prompts you to input the specific parking information such as floor, spot and any
    ...
    <div class="row green-background">
        ...
        <div class="col-sm-6 park-pin-pad">
            ...
            <p class="white">
                ...
                park, or mall and wonder "Where did I park MyCar Parking again? Simply open MyCar and pin your parking location.
    ...
    <div class="row download-background">
        <div class="text-center">
            ...
            <h2 class="white">Download The MYCAR Parking App</h2>
